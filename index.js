...
const unfundedGamesText = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${numUnfundedGames} game${numUnfundedGames !== 1 ? 's' : ''} remain${numUnfundedGames !== 1 ? '' : 's'} unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const pElement = document.createElement('p');
pElement.textContent = unfundedGamesText;
